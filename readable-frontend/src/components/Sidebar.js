      ...
      <div
        className={
          toggleSidebar
            ...
            : "d-none d-md-flex flex-column sidebar"
        }
      >
        <div className="col">
          <a
            href="/"
            className="brand d-flex align-items-center text-success text-decoration-none"
          >
            <HiAtSymbol size={30} />
          ...
          <button
            type="button"
            className="dismiss-btn d-md-none"
